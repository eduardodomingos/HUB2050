...
if ($hero_image) :
    ...
    $hero_image_opacity = (100 - get_field( 'hero_image_opacity', get_option('page_for_posts') ) ) / 100;
    ?>
...
<div class="container">
<?php
$hero_text = get_field( 'hero_text' , get_option('page_for_posts'));
if ($hero_text) : ?>
<p class="hero-text animated fadeIn"><?php echo $hero_text; ?></p>
<?php endif; ?>
</div><!-- .container-->
<button id="scroll">
    <span>scroll</span>
