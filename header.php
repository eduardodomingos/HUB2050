...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="container">
			...
			<?php
			$hub_description = get_bloginfo( 'description', 'display' );
			if ( $hub_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $hub_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .container -->
